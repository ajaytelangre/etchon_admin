...
if(Helper::is_post()){
    ...
    if($api_token){
        ...
        if(!empty($setting)){
            if(isset($_POST["email"]) && isset($_POST["phone"]) && isset($_POST["password"]) && isset($_POST["type"])
            
            && isset($_POST["company"]) && isset($_POST["country"])
                ...
                $user->company = trim($_POST["company"]);
               ...
               // $user->company = trim($_POST["company"]);
                ...
                if($user->type == 1){
                    ...
                    /*EMAIL LOGIN*/
                    $user->validate_with(["email", "password", "username","phone","country"]);
