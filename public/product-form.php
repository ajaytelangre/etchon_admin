...
if(!empty($admin)){
    ...
    $all_rewards = new Reward();
    $all_rewards = $all_rewards->where(["status"=>1])->all();
    $discount = $discount->where(["status"=>1])->all();
                ...
                <form data-validation="true" action="../private/controllers/product.php" method="post" enctype="multipart/form-data">
                    <div class="item-inner">
                        ...
                        <div class="item-content">
                            ...
                            <label>Price For User A</label>
                            <div class="price-input">
                                <span><?php echo  $panel_setting->currency_font; ?></span>
                                <input type="text" data-required="numeric" placeholder="Price For User A" name="price_userA" value="<?php echo $product->price_userA; ?>"/>
                            </div>
                            
                            <label>Price For User B</label>
                            <div class="price-input">
                                <span><?php echo  $panel_setting->currency_font; ?></span>
                                <input type="text" data-required="numeric" placeholder="Price For User B" name="price_userB" value="<?php echo $product->price_userB; ?>"/>
                            </div>
                            
                              <label>Price For USD</label>
                            <div class="price-input">
                                <span> $<?php// echo  $panel_setting->currency_font; ?></span>
                                <input type="text" data-required="numeric" placeholder="Price For User C" name="price_userC" value="<?php echo $product->price_userC; ?>"/>
                            </div>
                            ...
                            <?php if($discount > 0){ ?>
                                <select name="discount" data-required="dropdown">
                                    <option selected="true" disabled="disabled">Please select a Discount</option>
                                    <?php foreach($discount as $item){ ?>
                                        <?php if($product->discount == $item->id) $selected_discount = "selected";
                                            else $selected_discount = ""; ?>

                                        <option value="<?php echo $item->id; ?>"  <?php echo $selected_discount; ?>><?php echo $item->amt; ?></option>
                                    <?php }?>
                                </select>
                            <?php  } ?>

                            <?php if($all_rewards > 0){ ?>
                                <select name="reward" data-required="dropdown">
                                    <option selected="true" disabled="disabled">Please select a Reward</option>
                                    <?php foreach($all_rewards as $item){ ?>
                                        <?php if($product->reward == $item->id) $selected_reward = "selected";
                                            else $selected_reward = ""; ?>

                                        <option value="<?php echo $item->id; ?>"  <?php echo $selected_reward; ?>><?php echo $item->amt; ?></option>
                                    <?php }?>
                                </select>
                            <?php  } ?>
                            ...
                            <input type="text" data-required="true" placeholder="Part Code" name="part_code" value="<?php echo $product->part_code; ?>"/>
                            <!--<?php echo $product->part_code; ?>  -->
                            <label>HSN Code</label>
                            <input type="text" data-required="true" placeholder="HSN Code" name="hsn_code" value="<?php echo $product->hsn_code; ?>"/>
                            <!-- <?php echo $product->hsn_code; ?> -->

                            <label>Product Weight</label>
                            <input type="text" data-required="true" placeholder="Product Weight" name="product_weight" value="<?php echo $product->product_weight; ?>"/>
                            ...
                            <h6 class="right-text mb-30"><a data-popup="#attribute-popup" class="link" href="#">+  Product Availability</a></h6>
                                    ...
                                    <div class="combined-attr-inner">
                                        ...
                                        <input data-required="true" placeholder="Quantity" name="qty<?php echo $attr_id; ?>" id="<?php echo $attr_id; ?>"
                                               value="<?php echo $item->quantity; ?>" class="qty">
                                                                            ...
                                                                            <input data-required="true" placeholder="Price" name="prcQty<?php echo $attr_id; ?>" id="<?php echo $attr_id; ?>"
                                               value="<?php echo $item->price; ?>" class="form-control">
            ...
            <div class="dplay-tbl-cell">
                <div class="item">
                    <div class="item-inner">
                        ...
                        <div class="item-header">
                            <h5 class="dplay-inl-b">Conformation</h5>
                        </div><!--item-header-->
                        ...
                        <div class="item-content ptb-15">
                            ...
                            <div>
                                <h6 class="mt-15 mb-15">Selected Conformation</h6>
                                <form>
 ...
 <script>
     ...
     function renderCombinedAttr(combinedCB, newCbId, newCbText, attrQty){
         ...
         var cbWrapper = $('<div>', { class: 'combined-attr-inner' }),
             ...
             prcInput = $('<input>', { placeholder: 'Price', name: 'prcQty' + newId, id: newId, class: 'form-control'}).appendTo(cbWrapper);
